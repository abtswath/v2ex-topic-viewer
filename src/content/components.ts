const topicViewStylesheets = `.topic-viewer-container{overflow:auto;border-bottom:1px solid var(--box-border-color)}#Main{margin:0}`;
...
export class TopicViewer extends HTMLElement {
    ...
    constructor() {
        ...
        document.querySelectorAll('style').forEach(x => shadowRoot.appendChild(x));
